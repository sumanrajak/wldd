...
export default function Home() {
  ...
  return (
    <div className="email-container">
      ...
      <Nav.Item eventKey="home">Primary</Nav.Item>
      <Nav.Item eventKey="news">Promotion</Nav.Item>
      <Nav.Item eventKey="solutions">Social</Nav.Item>
    
    </Nav>
      {
        email.map((e,i)=>{
          return <EmailTabs data={e} key={i}/>
        })
        
      }
      {
            email.map((e,i)=>{
              return <EmailTabs data={e} key={i+"r"}/>
        })
      }
